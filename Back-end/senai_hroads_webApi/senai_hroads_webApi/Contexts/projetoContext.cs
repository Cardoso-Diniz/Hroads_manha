...
namespace senai.hroads.webApi.Contexts
{
    public partial class projetoContext : DbContext
    {
        ...
        public virtual DbSet<PersonagemDomain> Personagens { get; set; }
        public virtual DbSet<Tipo_HabilidadeDomain> Tipos_Habilidades { get; set; }
        public virtual DbSet<TipoUsuarioDomain> TiposUsuarios { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //optionsBuilder.UseSqlServer("Data Source=CONEXAOSENAIAQUI\\SQLEXPRESS; initial catalog=SENAI_HROADS_MANHA; user Id=sa; pwd=senai@132;");
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-7KLLDB1\\SQLEXPRESS; initial catalog=SENAI_HROADS_MANHA; user Id=cardoso; pwd=Senai@132;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Tipo_HabilidadeDomain>(entity =>
            {
